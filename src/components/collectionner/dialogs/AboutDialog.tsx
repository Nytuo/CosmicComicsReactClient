...
export default function AboutDialog({
  ...
  useEffect(() => {
    fetch(PDP + "/getVersion")
      .then(function (response) {
        return response.text();
      })
      .then(function (data) {
        setVersion(t("version") + " " + data.replaceAll('"', ""));
        Logger.info("Version: " + data.replace('"', ""));
      })
        ...
        <DialogContent sx={{ textAlign: "center" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <a href="https://nytuo.fr" target="_blank">
              <img src="Images/Nytuo_softwares.png" alt="" height="80px" />
            </a>
            <a href="https://nytuo.fr" target="_blank">
              <img src="Images/Nytuo website.png" height="80px" alt={"Logo"} />
            </a>
          </div>
        </DialogContent>
        <DialogActions>
