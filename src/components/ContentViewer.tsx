                ...
                <div id="ColTitle">{
                    type === "volume" ? (
                        (provider === providerEnum.Marvel) ?
                            <a target='_blank' href={((TheBook.URLs === null || TheBook.URLs === "null") ? ("#") : (JSON.parse(TheBook.URLs)[0].url))} style={{ color: 'white' }}>{TheBook.NOM}<i style={{ fontSize: '18px', top: '-10px', position: 'relative' }} className='material-icons'>open_in_new</i></a>
                        ...
                        (provider === providerEnum.Marvel) ?
                            ...
                            (provider === providerEnum.Anilist) ?
                                <a target='_blank' href={(TheBook.URLs == "null") ? ("#") : (TheBook.URLs)} style={{ color: 'white' }}>{TheBook.NOM}</a> :
                                <a target='_blank' style={{ color: 'white' }}>{TheBook.NOM}</a>
                }</div>
                <div id="ColContent">
                    <Grid2 container sx={
